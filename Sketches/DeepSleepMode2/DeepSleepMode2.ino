...
char SOME_TEXT[] = "Don't know why this is needed";
...
*/
/*
#if (DS_WAKEUP_SOURCE == SET_DS_AON_WAKEPIN_WAKEUP)
    #if (SET_DS_AON_WAKEPIN_WAKEUPPIN == 16)
        printf("%s. Set DS_AON_WAKEPIN_WAKEUP_D16\r\n", SOME_TEXT);
    #elif (SET_DS_AON_WAKEPIN_WAKEUPPIN == 17)
        //printf("%s.  Set DS_AON_WAKEPIN_WAKEUP_D17\r\n",DS_AON_WAKEPIN_WAKEUP_D17 );
        Serial.println(DS_AON_WAKEPIN_WAKEUP_D17);
    #endif
#endif
*/
        Serial.println(DS_AON_WAKEPIN_WAKEUP_D17);
