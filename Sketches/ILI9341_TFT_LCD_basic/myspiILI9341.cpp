...
void myspiILI9341::setAddress(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1)
{
    uint16_t x, y, w, h;
...
void myspiILI9341::fillScreen(uint16_t color)
{
    fillRectangle(0, 0, _width, _height, color);
}

void myspiILI9341::clr(void)
{
    fillScreen(background);
}

void myspiILI9341::fillRectangle(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color)
{
...
void myspiILI9341::drawPixel(int16_t x, int16_t y, uint16_t color)
{
...
void myspiILI9341::drawLine(int16_t x0, int16_t y0, int16_t x1, int16_t y1)
{
    drawLine(x0, y0, x1, y1, foreground);
}

void myspiILI9341::drawRectangle(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color)
{
...
void myspiILI9341::drawRectangle(int16_t x, int16_t y, int16_t w, int16_t h)
{
    drawRectangle(x, y, w, h, foreground);
}

void myspiILI9341::drawCircle(int16_t x0, int16_t y0, int16_t r, uint16_t color)
{
    int16_t f = 1 - r;
    int16_t ddF_x = 1;
    int16_t ddF_y = -2 * r;
...
void myspiILI9341::drawCircle(int16_t x0, int16_t y0, int16_t r)
{
    drawCircle(x0, y0, r, foreground);
}

size_t myspiILI9341::write(uint8_t c)
{
    if (c == '\n') {
        cursor_y += fontsize * 8;
        cursor_x = 0;
...
int16_t myspiILI9341::getWidth()
{
    return _width;
}

int16_t myspiILI9341::getHeight()
{
    return _height;
}

void myspiILI9341::setCursor(int16_t x, int16_t y)
{
    cursor_x = x;
    cursor_y = y;
}

void myspiILI9341::setForeground(uint16_t color)
{
    foreground = color;
}

void myspiILI9341::setBackground(uint16_t _background)
{
    background = _background;
}

void myspiILI9341::setFontSize(uint8_t size)
{
    fontsize = size;
}

void myspiILI9341::drawChar(unsigned char c)
{
    drawChar(cursor_x, cursor_y, c, foreground, background, fontsize);
}

void myspiILI9341::drawChar(int16_t x, int16_t y, unsigned char c, uint16_t _fontcolor, uint16_t _background, uint8_t _fontsize)
{
    int i, j;
    uint8_t line;
